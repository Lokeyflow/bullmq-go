...
// Source: npm package bullmq@5.62.0 dist/cjs/scripts/
//
// These scripts have all @include directives resolved and are production-ready.

const (
	// MoveToActive - Source: moveToActive-11.js
	MoveToActive = `--[[
...
`
	...
	// MoveToFinished - Source: moveToFinished-14.js
	MoveToFinished = `--[[
...
`
	...
	// RetryJob - Source: retryJob-11.js
	RetryJob = `--[[
...
`
	...
	// MoveStalledJobsToWait - Source: moveStalledJobsToWait-8.js
...
`
	...
	// ExtendLock - Source: extendLock-2.js
	ExtendLock = `--[[
...
`
	...
	// UpdateProgress - Source: updateProgress-3.js
	UpdateProgress = `--[[
  Update job progress
  Input:
    KEYS[1] Job id key
...
`
	...
	// MoveToCompleted is an alias for MoveToFinished
	// Use ARGV[5]="completed" when calling this script
	MoveToCompleted = MoveToFinished

	// MoveToFailed is an alias for MoveToFinished
	// Use ARGV[5]="failed" when calling this script
	MoveToFailed = MoveToFinished
)
